...
class SetCriterion(nn.Module):
    ...
    def __init__(
        self, num_classes, matcher, weight_dict, eos_coef, losses, emphasized_weights={}
    ):
...
def build(args):
    ...
    for num_classes, emphasized_weights in zip(
        args.num_classes_list, args.emphasized_weights_list
    ):
        model = DETRMulti(
            backbone,
            transformer,
        ...
        criterion = SetCriterion(
            ...
            losses=losses,
            emphasized_weights=emphasized_weights,
        )
        criterion.to(device)
