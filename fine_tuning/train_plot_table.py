...
TABLEBANK_WEIGHTS_PATH = os.path.join(ROOT_DIR, "mask_rcnn_tablebank_cfg.h5")
...
class CustomConfig(Config):
    ...
    NUM_CLASSES = 1 + 2  # Background + table and plot
...
def train(model):
    ...
    dataset_train.load_custom(os.path.join(ROOT_DIR, "table_plot_bank"), "train")
    dataset_train.prepare()

    # Validation dataset
    dataset_val = CustomDataset()
    dataset_val.load_custom(os.path.join(ROOT_DIR, "table_plot_bank"), "val")
    dataset_val.prepare()
...
weights_path = TABLEBANK_WEIGHTS_PATH
